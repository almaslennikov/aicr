...
require (
	...
	github.com/nvidia/k8s-launch-kit v0.0.0-20260625125931-a325c48523de
...
require (
	...
	github.com/Mellanox/doca-driver-build/entrypoint v0.0.0-20260421090033-dbd12d7e97a7 // indirect
